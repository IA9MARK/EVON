      ...
      <div className="filterSection">
        <div className="filterCategories">
          <Accordion defaultExpanded disableGutters elevation={0}>
            ...
            >
              <h5 className="filterHeading">Categorie Prodotti</h5>
            </AccordionSummary>
        ...
        <div className="filterColors">
          <Accordion defaultExpanded disableGutters elevation={0}>
            <AccordionSummary
              ...
              sx={{ padding: 0, marginBottom: 2 }}
            >
              <h5 className="filterHeading">Colori</h5>
            </AccordionSummary>
            <AccordionDetails sx={{ padding: 0 }}>
              {
        ...
        <div className="filterSizes">
          <Accordion defaultExpanded disableGutters elevation={0}>
            <AccordionSummary
              ...
              sx={{ padding: 0, marginBottom: 2 }}
            >
              <h5 className="filterHeading">Taglie</h5>
            </AccordionSummary>
            <AccordionDetails sx={{ padding: 0 }}>
            ...
            <AccordionDetails sx={{ padding: 0 }}>
              ...
              <div className="brandList">
                {filteredBrands.length > 0 ? (
                  ...
                  <div className="notFoundMessage">Non Trovato</div>
                )}
              </div>
            </AccordionDetails>
          </Accordion>
        ...
        <div className="filterPrice">
          <Accordion defaultExpanded disableGutters elevation={0}>
            <AccordionSummary
              ...
              sx={{ padding: 0, marginBottom: 2 }}
            >
              <h5 className="filterHeading">Prezzo</h5>
            </AccordionSummary>
            <AccordionDetails sx={{ padding: 0 }}>
              <Slider
              ...
              <div className="filterSliderPrice">
                <div className="priceRange">
                  <p>
                    Prezzo Minimo: <span>€{value[0]}</span>
                  </p>
                  <p>
                    Prezzo Massimo: <span>€{value[1]}</span>
                  </p>
                </div>
              </div>
            </AccordionDetails>
